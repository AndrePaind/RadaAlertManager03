...
export function AlertForm({
  ...
  const handleSuggestJustification = async () => {
    ...
    if (selectedRegions.length === 0) {
      toast({
        variant: 'destructive',
        title: 'Cannot suggest justification without selected regions.',
      });
    ...
    try {
      ...
      toast({
        variant: 'destructive',
        title: 'Failed to suggest justification',
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Textarea
                          placeholder="Explain the rationale for this alert..."
                          rows={5}
                          {...field}
                        />
                      </FormControl>
              ...
              <div className="lg:col-span-1 space-y-6">
                ...
                <div className="flex flex-col gap-2 pt-6">
                  ...
                  >
                    {alert?.status === 'draft' ? 'Save and Push' : 'Save Draft'}
                  </Button>
                  {alert?.status === 'active' && (
